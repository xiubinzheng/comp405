...
/**
 * {@code Project} creates a Project class to track 
 * specific information about a single project as 
 * related to a single client.
 */
...
public class Project
{
	...
	/**Changes the project's description also checks if the description is within the
	 * required length of 255 characters*/
	...
	/**Sets Project name with a String and checks if the name is 
	 * within the length of 50 characters.*/
	...
	/**When function is called project status is changed from incomplete to complete.*/
